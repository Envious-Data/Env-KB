...
try:        
    ...
    CATKEY = make_key(on_press=catkey)
    ...
    envkb.keymap = [
        ...
        #Layer 1
            ...
            KC.TRNS, nokey, CATKEY, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, nokey, nokey, nokey, nokey,
